...
SECRET_KEY = 'django-insecure-y9&b1-9(43^zm_4-4h33^&y#y(%7xg^4(c@=a0$8z&!78r5mx5'
...
INSTALLED_APPS = [
    ...
    'financeDjango.discount_factor_app.apps.DiscountFactorAppConfig',
...
AUTHENTICATION_BACKENDS = [
    'financeDjango.accounts.authentication.EmailOrUsernameBackend',
